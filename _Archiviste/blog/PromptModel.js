...
async function main() {
  ...
  const completion = await groq.chat.completions.create({
    ...
    messages: [
      ...
      {role: "assistant", content: "Entraînement du modèle en cours..."} // Afficher l'état d'entraînement
    ],
    model: "gemma2-9b-it",
    temperature: 0.5,
    max_tokens: 4096,
    ...
    console.log("🏁 La liste de sujets pour le blog a été générée et enregistrée sur github dans " + outputFilePath);
  });
}
