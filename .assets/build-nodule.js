...
const nodule = process.argv[2] || 'EcoSystem_'; //  Obtenir le sujet via l'argument de ligne de commande

const nodeJs = [
     "howto-nodule_groq-sdk_argument-prompt",
     "howto-nodule_groq-sdk_argument-subject",
     "howto-nodule_groq-sdk_argument-topics",
     "howto-nodule_groq-sdk_argument-regex",
